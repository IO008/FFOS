    ...
    63                                          [SECTION .text]
    64 00000000                                 	GLOBAL	_init_paletee
    65 00000000                                 _init_paletee:
    ...
    94 0000003F 7D 48                           	JGE	L9
    95 00000041 29 DF                           	SUB	EDI,EBX
    96 00000043 89 FB                           	MOV	EBX,EDI
    97 00000045                                 L7:
    98 00000045 8A 06                           	MOV	AL,BYTE [ESI]
    99 00000047 C0 E8 02                        	SHR	AL,2
   100 0000004A 0F B6 C0                        	MOVZX	EAX,AL
   101 0000004D 50                              	PUSH	EAX
   102 0000004E 68 000003C9                     	PUSH	969
   103 00000053 E8 [00000000]                   	CALL	_io_out8
   104 00000058 8A 46 01                        	MOV	AL,BYTE [1+ESI]
   105 0000005B C0 E8 02                        	SHR	AL,2
   106 0000005E 0F B6 C0                        	MOVZX	EAX,AL
   107 00000061 50                              	PUSH	EAX
   108 00000062 68 000003C9                     	PUSH	969
   109 00000067 E8 [00000000]                   	CALL	_io_out8
   110 0000006C 8A 46 02                        	MOV	AL,BYTE [2+ESI]
   111 0000006F C0 E8 02                        	SHR	AL,2
   112 00000072 83 C6 03                        	ADD	ESI,3
   113 00000075 0F B6 C0                        	MOVZX	EAX,AL
   114 00000078 50                              	PUSH	EAX
   115 00000079 68 000003C9                     	PUSH	969
   116 0000007E E8 [00000000]                   	CALL	_io_out8
   117 00000083 83 C4 18                        	ADD	ESP,24
   118 00000086 4B                              	DEC	EBX
   119 00000087 75 BC                           	JNE	L7
   120 00000089                                 L9:
   121 00000089 8B 45 F0                        	MOV	EAX,DWORD [-16+EBP]
   122 0000008C 89 45 08                        	MOV	DWORD [8+EBP],EAX
   123 0000008F 8D 65 F4                        	LEA	ESP,DWORD [-12+EBP]
   124 00000092 5B                              	POP	EBX
   125 00000093 5E                              	POP	ESI
   126 00000094 5F                              	POP	EDI
   127 00000095 5D                              	POP	EBP
   128 00000096 E9 [00000000]                   	JMP	_io_store_eflags
